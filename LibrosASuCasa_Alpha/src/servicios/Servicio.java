...
public class Servicio implements InterfaceServicio{
	...
	public void Alta(List<String> list){
		Libro libro=new Libro( Integer.parseInt(list.get(0)), list.get(1), list.get(2), list.get(3), list.get(4), Double.parseDouble(list.get(5)), Integer.parseInt(list.get(6)));
		datos.Alta(libro);
	}
